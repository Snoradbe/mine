...
class DefaultConnector implements Connector
{
    ...
    public function addByServer(Server $server, $timeout = 1.0): void
    {
        $pass = config('site.game.rcon.server_' . $server->getId(), '');
    ...
    /**
     * @param string $name
     * @return Connection|DefaultConnection|mixed
     * @throws ServerDoesNotExistsException
